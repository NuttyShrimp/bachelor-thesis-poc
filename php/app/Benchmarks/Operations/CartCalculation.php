...
class CartCalculation
{
    ...
    public static function benchmark(string $scenario = 'large_cart', int $iterations = 100): array
    {
        ...
        return [
            ...
            'p25_time_ms' => $times[(int)(count($times) * 0.25)],
            'p50_time_ms' => $times[(int)(count($times) * 0.50)],
            'p75_time_ms' => $times[(int)(count($times) * 0.75)],
            'p95_time_ms' => $times[(int)(count($times) * 0.95)],
            'p99_time_ms' => $times[(int)(count($times) * 0.99)],
